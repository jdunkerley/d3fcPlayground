(function (global, factory) {
    ...
    global.fc = factory(global.computeLayout,global.d3,global.svgInnerhtml);
}(this, function (computeLayout,d3,svgInnerhtml) { 'use strict';
    ...
    function _dataJoin() {
        ...
        var dataJoin = function(container, data) {
            ...
            var joinedData = data || identity$1;
    ...
    function axisSvg() {
        ...
        var axis = function(selection) {
            ...
            selection.each(function(data, index) {
                ...
                var tickFormatter = tickFormat == null ? tryApply('tickFormat', identity$1) : tickFormat;
    ...
    function identity() {
        ...
        identity.clampUp = identity$1;

        identity.clampDown = identity$1;
    ...
    */
    ...
    function macd() {
        ...
        var macdAlgorithm = calculator$1()
            .value(function(d) { return d.close; });
    ...
    var calculator = {
        ...
        relativeStrengthIndex: calculator$2,
        stochasticOscillator: calculator$3,
    ...
    function legend() {
        ...
        var tableDataJoin = _dataJoin()
            .selector('table.legend')
            .element('table')
            .attr('class', 'legend');

        var rowDataJoin = _dataJoin()
            .selector('tr.row')
            .element('tr')
            .attr('class', 'row');
